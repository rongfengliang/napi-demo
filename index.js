      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-android-arm64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-android-arm-eabi')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-win32-x64-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'ia32':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-win32-ia32-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-win32-arm64-msvc')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'darwin':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('@dalongrong/napi-demo-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-darwin-x64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-darwin-arm64')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'freebsd':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('@dalongrong/napi-demo-freebsd-x64')
      }
    } catch (e) {
      loadError = e
    }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@dalongrong/napi-demo-linux-x64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@dalongrong/napi-demo-linux-x64-gnu')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@dalongrong/napi-demo-linux-arm64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@dalongrong/napi-demo-linux-arm64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@dalongrong/napi-demo-linux-arm-gnueabihf')
          }
        } catch (e) {
          loadError = e
        }
